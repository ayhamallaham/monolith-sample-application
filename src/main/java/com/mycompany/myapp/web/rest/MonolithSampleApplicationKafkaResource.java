...
@RestController
@RequestMapping("/api/monolith-sample-application-kafka")
public class MonolithSampleApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MonolithSampleApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MonolithSampleApplicationKafkaResource(KafkaProperties kafkaProperties) {
