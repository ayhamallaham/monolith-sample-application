...
class MonolithSampleApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        MonolithSampleApplicationKafkaResource kafkaResource = new MonolithSampleApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/monolith-sample-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/monolith-sample-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
